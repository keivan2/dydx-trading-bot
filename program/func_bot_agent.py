...
class BotAgent:
    ...
    """
    Primary function of the BotAgent handles opening and checking order status
    """
    ...
    def check_order_status_by_id(self, order_id):
        ...
        # Guard: IF order not filled wait untill order expiration
